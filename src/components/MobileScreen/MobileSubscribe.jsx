...
const styles = {
  container:
    " md:hidden w-full h-full bg-lightBlue flex justify-center    my-20 md:px-24",
  contentContainer: "mt-2 flex flex-col justify-center  items-center px-2",
  inputContainer:
    " w-11/12  sm:w-full  lg:w-8/12 bg-white flex mt-[1rem] justify-between rounded-[2.5rem] px-6 py-4 ",
  input:
    "border-none outline-none w-10/12 text-grey-dark text-lg biome-regular ",
  title: "text-white gradient-text  text-[1.375rem] sm:text-[1.5rem] mb-12 lg:mb-2 lg:text-[2.5rem] mt-[5vh] lg:mt-[7.5rem] text-center biome-bold ",
