...
import carImg from "../../assets/mobileCar.png";
import playerImg from "../../assets/mobilePlayer.png";
...
const imagesArray = [
  ...
  carImg,
  "https://media.publit.io/file/shapes-and-light-1.png",
  "https://media.publit.io/file/shapes-and-light.png",
  "https://media.publit.io/file/shapes-and-light-7.png",
  "https://media.publit.io/file/shapes-and-light-8.png",
  "https://media.publit.io/file/shapes-and-light-3.png",
...
const styles = {
  container:
    "sm:hidden w-full hero-h bg-lightBlue flex justify-center items-center transition-all ease-in-out mt-4 mb-4 lg:mb-12",
  contentContainer: "w-full",
  sectionContainer:
    "w-full h-full flex flex-col justify-end   lg:flex-row  p-4  ",
  sectionA: "w-full mt-[30vh] md:mt-28 w-full lg:w-6/12 flex flex-col  sm:h-full md:px-4 ml-4",
  ...
  sectionB:
    "w-full md:w-5/12 h-full  mt-8 md:mt-0 flex flex-col  md:justify-end md:items-end ",
  iconContainer:
    "w-full  flex justify-around    pb-8 ",
